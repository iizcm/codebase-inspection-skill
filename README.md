...
| Field | Value |
| --- | --- |
| **Name** | `codebase-inspection-skill` |
...
cp -r github/codebase-inspection ~/.hermes/skills/github/codebase-inspection/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/codebase-inspection-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/codebase-inspection-skill.git ~/.hermes/skills/github/codebase-inspection/
```
...
```text
skill_view(name="github/codebase-inspection")
```
...
```text
Use the codebase inspection skill to <describe your specific task here>
```
...
```text
Gunakan skill codebase inspection untuk <deskripsikan tugas spesifik Anda di sini>
```
